    ...
    <div className="bg-black/80 backdrop-blur-sm fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="bg-zinc-900 w-full max-w-lg rounded-2xl flex flex-col max-h-[80vh] border border-zinc-800">
        <h2 className="text-white font-bold border-b border-zinc-800 pb-4 m-6 mb-0 text-xl">
          Syarat & Ketentuan Gymnox
        </h2>
        
        <div className="overflow-y-auto p-6 text-sm text-zinc-400 space-y-4">
          <p>
            1. <strong>Sistem Pay-per-visit:</strong> Ekosistem Gymnox beroperasi menggunakan konsep pay-per-visit dengan mata uang digital berupa kredit dompet. Setiap sesi latihan di gym mitra akan memotong saldo kredit Anda sesuai dengan harga yang ditetapkan oleh masing-masing gym.
          </p>
          <p>
          ...
          <p>
            3. <strong>Tata Tertib Mitra Gym:</strong> Sebagai member Gymnox, Anda diwajibkan untuk mematuhi semua tata tertib dan peraturan yang berlaku di setiap lokasi gym mitra yang Anda kunjungi. Segala bentuk pelanggaran dapat mengakibatkan pencabutan akses sementara hingga permanen pada platform Gymnox.
          </p>
          <p>
